...
embedding_model_dict = {
    ...
    "text2vec": "/home/cambricon/lsc/data/models/embedding/text2vec-large-chinese",
    #"text2vec": "/workspace/data/models/embedding/text2vec-large-chinese",
...
llm_model_dict = {
    ...
    "chatglm2-6b": {
        ...
        "local_model_path": "/home/cambricon/lsc/data/models/chatglm2-6b",
        "provides": "ChatGLMLLMChain"
    },
    "chatglm2-6b-int4": {
        "name": "chatglm2-6b-int4",
        "pretrained_model_name": "THUDM/chatglm2-6b-int4",
        "local_model_path": "/home/cambricon/lsc/data/models/chatglm2-6b-int4",
        "provides": "ChatGLMLLMChain"
    },
    "chatglm2-6b-int8": {
...
根据上述{}内的已知信息，回答用户的问题。回答中包含的数学、物理公式及化学方程式请用latex的语法表示。如果无法从{}得到答案，请说 “根据已知信息无法回答该问题” ，不允许在答案中添加编造成分。 问题是：{question}"""

PROMPT_TEMPLATE1 = """你的任务：根据{}内的信息，提取出信息的主体。信息一般是一个问句，信息的主体一般是这个问句最关切的一个名词。
